...
# ftest = pd.read_csv(
#     'C:\\Users\\admin\\Desktop\\GIT\\OPEN IIT\\Data_Analytics\\test.csv')
# ftrain = pd.read_csv(
#     'C:\\Users\\admin\\Desktop\\GIT\\OPEN IIT\\Data_Analytics\\train.csv')
...
print(fnew)
fnew.to_csv(
    'C:\\Users\\admin\\Desktop\\GIT\\OPEN IIT\\Data_Analytics\\output_NB.csv')
